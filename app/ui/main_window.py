...
from app.ui.dialogs import ModelConversionDialog, ScanStatisticsDialog, SkippedFilesDialog
from app.ui.options import OptionsPanel, PerformancePanel, QCPanel, ScanOptionsPanel
...
app_logger = logging.getLogger("PixelHand.ui.main")
...
class App(QMainWindow):
    ...
    def _setup_ui(self):
        ...
        # Left Splitter (Vertical: Options vs Log)
        ...
        # Right Splitter (Horizontal: Results vs Viewer)
