...
title PixelHand Portable Launcher (WebGPU)
...
set "UV_PROJECT_ENVIRONMENT=%~dp0.venv-webgpu"

echo =======================================================
echo      PixelHand Portable Launcher via UV [WebGPU]
echo =======================================================
echo.
echo [INFO] Tools Dir: .tools
echo [INFO] Venv Dir:  .venv-webgpu
echo.
...
echo [INFO] Syncing dependencies for WebGPU...
echo.

"%UV_EXE%" run --extra webgpu main.py %*
